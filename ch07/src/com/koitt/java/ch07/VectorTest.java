...
public class VectorTest {
	public static void main(String[] args) {
		...
		List<Object> data = new Vector<Object>(3); // 처음에 만들어지는 배열의 크기: 3
		// Vector data = new Vector(3); //경고발생
		
		((Vector<Object>)data).addElement(2012); // add와 addElement는 기능의 차이는 없음 
		data.add("년도");
		...
		System.out.println("capacity = " + ((Vector<Object>)data).capacity());	// 배열의 용량 : 본래 배열용량 3에서 값이 늘어나므로 2배로 키웠기 떄문에 6
